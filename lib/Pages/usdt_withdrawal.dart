...
import 'package:arbitex/Pages/save_usdt_address.dart';
import 'package:flutter/material.dart';

class UsdtWithdrawal extends StatefulWidget {
  const UsdtWithdrawal({Key? key}) : super(key: key);
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              const Padding(
                ...
                child: Text(
                  'USDT Withdrawal', style: TextStyle(
                    fontSize: 24,
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        SizedBox(width: 13),
                        Text('Add USDT Wallet Address', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.blue[900]),),
                      ],
                    ),
                  ),
                ),
              ...
              Text(
                'Saved USDT Address (TRC20)', style: TextStyle(
                fontSize: 12,
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: Center(child: Padding(
                    ...
                    child: Text(usdtWallet, style: const TextStyle(
                        fontSize: 18,
                        fontWeight: FontWeight.w500
                    ),),
                  ),
