...
class LtcWithdrawal extends StatefulWidget {
  const LtcWithdrawal({Key? key}) : super(key: key);

  @override
  _LtcWithdrawalState createState() => _LtcWithdrawalState();
}

class _LtcWithdrawalState extends State<LtcWithdrawal> {
  @override
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            const Padding(
              ...
              child: Text(
                'LTC Withdrawal', style: TextStyle(
                  fontSize: 24,
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      SizedBox(width: 13),
                      Text('Add LTC Wallet Address', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.blue[900]),),
                    ],
                  ),
                ),
              ),
            ...
            Text(
              'Saved LTC Address (TRC20)', style: TextStyle(
              fontSize: 12,
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Center(child: Padding(
                  ...
                  child: Text(ltcWallet, style: TextStyle(
                      fontSize: 18,
                      fontWeight: FontWeight.w500
                  ),),
                ),
