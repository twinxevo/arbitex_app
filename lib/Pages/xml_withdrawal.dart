...
class XmlWithdrawal extends StatefulWidget {
  const XmlWithdrawal({Key? key}) : super(key: key);

  @override
  _XmlWithdrawalState createState() => _XmlWithdrawalState();
}

class _XmlWithdrawalState extends State<XmlWithdrawal> {
  @override
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            const Padding(
              ...
              child: Text(
                'XML Withdrawal', style: TextStyle(
                  fontSize: 24,
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      SizedBox(width: 13),
                      Text('Add XML Wallet Address', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.blue[900]),),
                    ],
                  ),
                ),
              ),
            ...
            Text(
              'Saved XML Address (TRC20)', style: TextStyle(
              fontSize: 12,
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Center(child: Padding(
                  ...
                  child: Text(xmlWallet, style: TextStyle(
                      fontSize: 18,
                      fontWeight: FontWeight.w500
                  ),),
                ),
