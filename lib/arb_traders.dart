...
class ArbTraders extends StatelessWidget {
  ArbTraders({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
            ...
            child: Stack(
              children: <Widget>[
                Container(
                  ...
                  margin: EdgeInsets.fromLTRB(0.0, 33.0, 0.0, 0.0),
                ),
                Pinned.fromPins(
                  Pin(start: 47.0, end: 0.0),
                  Pin(size: 35.0, middle: 0.3898),
                  child: Text(
                    'Buy - Binance \$44,900\nSell - Houbi \$45,080',
                    style: TextStyle(
                      fontFamily: 'Roboto',
                ...
                Align(
                  alignment: Alignment(0.049, 0.492),
                  child: SizedBox(
                    width: 61.0,
                    height: 21.0,
                    child: Text(
                ...
                Align(
                  alignment: Alignment(0.022, -0.462),
                  child: SizedBox(
                    width: 60.0,
                    height: 21.0,
                    child: Text(
          ...
          Pinned.fromPins(
            Pin(size: 72.0, start: 51.0),
            Pin(size: 72.0, middle: 0.1697),
            child: Stack(
              children: <Widget>[
                Container(
                  decoration: BoxDecoration(
